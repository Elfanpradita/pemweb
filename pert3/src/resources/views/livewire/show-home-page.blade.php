		...
		<div class="row align-items-center justify-content-center">
		  <div class="col-lg-6 mb-5 mb-lg-0">
			<div class="block text-center text-lg-start pe-0 pe-xl-5">
			  ...
			  <a type="button" class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#applyLoan">See More
				<span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span>
			  </a>

			  <!-- Tombol untuk menuju ke FAQ -->
			  <a type="button" class="btn btn-secondary mt-3" href="{{ route('faq') }}">Go to FAQ
				<span style="font-size: 14px;" class="ms-2 fas fa-question-circle"></span>
			  </a>
			</div>
		  </div>
		  <div class="col-lg-6">
